...
public:
  explicit HikCameraNode(const rclcpp::NodeOptions & options) : Node("hik_camera", options)
  {
    ...
    left_camera_pub_ = image_transport::create_camera_publisher(this, "image_left", qos);
    ...
    right_camera_pub_ = image_transport::create_camera_publisher(this, "image_right", qos);
